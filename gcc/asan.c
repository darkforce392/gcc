  ...
  if (flag_sanitize & SANITIZE_USER_ADDRESS)
    {
      ...
      // For Address Watcher instrument an extra function at the start
      fn = builtin_decl_implicit (BUILT_IN_ASAN_BINARY_DATE);
      time_t rawtime;
      // Pass a constant to this function: the current time during instrumentation.
      // This will be needed when checking if Address Watcher report is still valid for this run.
